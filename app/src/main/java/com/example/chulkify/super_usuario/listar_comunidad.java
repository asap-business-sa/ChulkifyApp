...
public class listar_comunidad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_comunidad);

        tabLayout= (TabLayout) findViewById(R.id.tb_layout_soli);
        viewPager= (ViewPager) findViewById(R.id.view_pager_soli);

        tabLayout.setupWithViewPager(viewPager);
        viewPager.setAdapter(new Adapter_list_comu(getSupportFragmentManager()));
    }
}